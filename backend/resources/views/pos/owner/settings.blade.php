    ...
    <main class="flex-1 min-w-0">
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                ...
                <button class="flex items-center gap-2 px-5 py-2.5 text-sm font-semibold rounded-lg transition-all bg-blue-600 text-white hover:bg-blue-700">
                    Save Changes
                </button>
            </div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <label class="p-4 rounded-xl border-2 cursor-pointer transition-all border-blue-600 bg-blue-50/50">
                            <input type="radio" name="template" class="sr-only" checked>
