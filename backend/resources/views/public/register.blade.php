        ...
        <div class="w-full max-w-lg" data-stepper data-step-current="1">
            ...
            <form action="{{ route('register') }}" method="post" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 surface-fade-up">
                ...
                <div data-step="1">
                    ...
                    <div class="space-y-4">
                        <div><label for="company_name" class="block text-sm font-medium text-gray-700 mb-1.5">Company Name</label><input id="company_name" name="company_name" type="text" value="{{ old('company_name') }}" placeholder="e.g., Perera Grocery" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"></div>
                        <div><label for="company_email" class="block text-sm font-medium text-gray-700 mb-1.5">Business Email</label><input id="company_email" name="company_email" type="email" value="{{ old('company_email') }}" placeholder="info@pereragrocery.lk" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"></div>
                ...
                <div data-step="2" class="hidden">
                    ...
                    <div class="space-y-4">
                        <div><label for="owner_name" class="block text-sm font-medium text-gray-700 mb-1.5">Full Name</label><input id="owner_name" name="owner_name" type="text" value="{{ old('owner_name') }}" required placeholder="Nimal Perera" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"></div>
                        <div><label for="owner_email" class="block text-sm font-medium text-gray-700 mb-1.5">Email Address</label><input id="owner_email" name="owner_email" type="email" value="{{ old('owner_email') }}" required placeholder="nimal@pereragrocery.lk" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"></div>
